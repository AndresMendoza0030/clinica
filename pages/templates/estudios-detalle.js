...
export function renderEstudioDetallePage({
  title,
  breadcrumb,
  heroImage,
  badge = "Diagnóstico por imágenes",
...
<html class="light" lang="es">
  <head>
    ...
    <meta
      name="description"
      content="Consulte los estudios disponibles de ${title} en Clínica Dr. Mendoza."
    />
    <link
      rel="icon"
      type="image/png"
          ...
          <div class="flex flex-wrap items-center justify-between gap-4">
            <div>
              ...
              <p class="mt-2 text-sm md:text-base text-soft dark:text-[#d3c1c1]">
                Puede escribirnos para confirmar información general, sede y preparación del estudio.
              </p>
            </div>
