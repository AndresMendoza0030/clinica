          ...
          <div class="max-w-[1280px] mx-auto">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              >
                ...
                <h3 class="text-xl font-bold text-[#1c0d0d] dark:text-white mb-2">Diagn\xF3stico por im\xE1genes</h3>
              ...
              >
                ...
                <h3 class="text-xl font-bold text-[#1c0d0d] dark:text-white mb-2">Laboratorio cl\xEDnico</h3>
                <p class="text-[#634f4f] dark:text-[#d3c1c1] text-sm leading-relaxed mb-4 flex-grow">
...
// .wrangler/tmp/bundle-c2y2cX/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-c2y2cX/middleware-loader.entry.ts
